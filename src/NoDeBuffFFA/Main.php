...
namespace NodeBuffFFA;

use NodeBuffFFA\entity\EntityJoinFFA;
use NoDeBuffFFA\task\EntityTag;
...
class Main extends PluginBase implements Listener{
	...
	public function onEnable(){
		...
		$this->getLogger()->info(TextFormat::GREEN . "is Enabled!");
		$this->getLogger()->info(TextFormat::GREEN . "Support: Dready");
		...
		if($cmd->getName() == "ffa"){
			...
			switch($args[0]){
				...
				case "about":
					...
					$player->sendMessage(TextFormat::GREEN . "NoDeBuff FFA" . $this->getDescription()->getVersion());
				break;
